<%-- 
    Document   : header
    Created on : 4 août 2016, 02:22:34
    Author     : akadjelvis
--%>
...
<html>
    <head>
        ...
        <title>Alinagnon: Système de réservation de billets bus en ligne au Bénin!</title>
        ...
        <script>
            $(function () {
                ...
                $("#oubliemdp").click(function () {
                    $("#mdp").removeClass("required");
                    $("#login").submit();
                    $("#mdp").addClass("required");
                    return false;
                });
                $("#login").validate()
            });
    ...
    <body background="assets/img/bus.jpg">
        <div class="container-fluid">
            <div class="myheader col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ALINAGNON: Système de réservation de billets bus en ligne!</div>