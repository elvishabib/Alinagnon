 ...
 * @author akadjelvis
 */
public class SupprimerBus extends HttpServlet {
 ...
 /*out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SupprimerBus</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SupprimerBus at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
 ...
 /*@Override
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        success = model.SupprimerBus();
        if (success) {
            response.sendRedirect("getBus.jsp?msg=Bus supprime avec succes!");
        }
    }
